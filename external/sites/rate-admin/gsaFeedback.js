...
(function( $ ){
 ...
 jQuery.fn.gsaFeedback = function(settings){
    ...
    return this.each(function(){
		...
		//Markup
    	var theForm = "<div id='gsaFeedback' class='bootstrap'>\
							<div id='gsaFeedbackTab' class='tab'>\
								<a id='tabText' href='#'></a>\
							</div>\
							<div class='body'>\
								<h3 id='headerText'></h3>\
								<p id='queryText'></p>\
									...
									<div class='load'>Sending...</div>\
								</div>\
							\
						<form method='POST' target='form-target' onsubmit=\"\">\
							<iframe src='#' id='form-target' name='form-target' style='width:0px; height:0px; border:0px;'></iframe>\
<label id='rating' for='entry.10480988'></label>\
<input type='text' name='entry.10480988' value='' class='rating' id='entry_10480988' dir='auto'>\
<label id='comments' for='entry.1335745066'></label>\
<input type='text' name='entry.1335745066' value='' class='comments' id='entry_1335745066' dir='auto'>\
...
<input type='hidden' name='pageHistory' value='0'>\
		...
		var oneFive = '<span id="oneText"></span>\
						...
						<span id="fiveText"></span>';
						
		var yesNo = '<div class="btn-group" data-toggle="buttons-radio">\
		...
		if (config.queryType === 'oneFive'){
			$('#gsaFeedback .query').attr('id','oneFive').prepend(oneFive);
			$('#gsaFeedback #oneText').text(config.oneText);
			$('#gsaFeedback #fiveText').text(config.fiveText);
		}
		else{
			$('#gsaFeedback .query').attr('id','yesNo').prepend(yesNo);
		}
